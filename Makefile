...
a.out: main.o my_mas_funcs.o
	@$(CC) $(CFLAGS) build/my_mas_funcs.o build/main.o


main.o: src/main.cpp
	@$(CC) $(CFLAGS) -c src/main.cpp -o build/main.o

my_mas_funcs.o: src/my_mas_funcs.cpp
	@$(CC) $(CFLAGS) -c src/my_mas_funcs.cpp -o build/my_mas_funcs.o
